...
def test_write_bids(cdtmppath):
    ...
    testlist = [({'suffix': 'T1w', 'subject': '1'}, testnii, 'sub-1/anat/sub-1_T1w.nii', None),
                ...
                ({'subject': 'abc', 'skullstripped': 'true', 'description': 'nucor', 'suffix': 'T1w'}, testnii,
                 'sub-abc/anat/sub-abc_skullstripped-true_desc-nucor_T1w.nii', None),
                ({'subject': '1', 'description': 'brain', 'suffix': 'mask', 'space': 'T1w'}, testnii,
                ...
                ({'subject': '1', 'space': 'T1w', 'suffix': 'mask', 'map_': 'MNI152', 'description': 'brain'}, testnii,
                 'sub-1/anat/sub-1_space-T1w_desc-brain_map-MNI152_mask.nii', None),
                ({'subject': '1', 'suffix': 'dseg', 'space': 'T1w', 'description': 'tissue'}, testnii,
                 'sub-1/anat/sub-1_space-T1w_desc-tissue_dseg.nii', labelinfo),
                ({'subject': '1', 'suffix': 'stats', 'description': 'tissue+lobes'}, testtsv,
